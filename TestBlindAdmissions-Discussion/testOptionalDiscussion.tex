...
\begin{frame}{Uncertainty about what college wants}
    ...
    % My suggestions: \begin{enumerate}
    %     \item Cite DiD lit, but argue not that related (counterfactual is some colleges dropping SATs). \pause
    %     \item Literature (including Borghesan paper) says dropping SATs won't improve selection of applicants; helps make case for this paper's argument.
    % \end{enumerate}
\end{frame}
...
\begin{frame}{Designing info}
    \begin{itemize}
        ...
        \begin{itemize}
            \item should interpret college in this paper as coalition of all colleges. \pause %one college closing its eyes is useless. 
